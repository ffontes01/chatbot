...
if prompt := st.chat_input("O que temos para hoje?"):
    messages = [
        ...
        {"role": "user", "content": "Gostaria que usasse respostas que ajudariam um designer pleno que quer ser Designer UI voltado para produtos tech como smartwatchs e afins, não precisa falar desse contexto explicitamente"},
